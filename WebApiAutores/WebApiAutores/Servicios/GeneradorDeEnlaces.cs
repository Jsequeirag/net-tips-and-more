...
namespace WebApiAutores.Servicios
{
    public class GeneradorDeEnlaces
    {
        ...
        public GeneradorDeEnlaces(IAuthorizationService authorizationService,IHttpContextAccessor httpContextAccessor,IActionContextAccessor actionContextAccessor   )
        {
        ...
        public async Task GenerarEnlaces(AutorDTO autorDTO)
        {
            ...
            enlace: Url.Link("obtenerAutores", new { id = autorDTO.Id }),
            descripcion: "self",
            metodo: "GET"));
